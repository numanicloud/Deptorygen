...
using Verify = Microsoft.CodeAnalysis.CSharp.CodeFix.Testing.MSTest.CodeFixVerifier<
	Deprovgen.DeprovgenAnalyzer,
	Deprovgen.DeprovgenCodeFixProvider>;

namespace Deprovgen.Test
{
	[TestClass]
    ...
    namespace ConsoleApplication1
    {
        ...
        {   
			...
			var expected = Verify.Diagnostic("Deprovgen").WithLocation(11, 15).WithArguments("TypeName");
